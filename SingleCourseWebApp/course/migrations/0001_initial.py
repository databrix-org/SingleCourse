    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_file', models.FileField(blank=True, help_text='Upload video content for the lesson', null=True, upload_to='lesson_videos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('exercise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='course.exercise')),
                ('members', models.ManyToManyField(related_name='exercise_groups', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='exercise',
            name='lesson',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_exercise', to='course.lesson'),
        ),
        migrations.CreateModel(
            name='LessonProgress',
            fields=[
        ...
        migrations.AddIndex(
            model_name='group',
            index=models.Index(fields=['exercise'], name='course_grou_exercis_afa606_idx'),
        ),
        migrations.AddIndex(
            model_name='exercise',
